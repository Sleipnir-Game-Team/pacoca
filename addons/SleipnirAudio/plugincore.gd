...
func _enter_tree() -> void:
	...
	preload("SFX/SoundQueue2D.gd"),preload("Icons/soundqueue2d.png"))
	...
	preload("Music/MaestroCore/SongData.gd"),preload("Icons/song_data.png"))

	add_custom_type("AudioInteractivePlayer","AudioStreamPlayer",
	preload("Music/MaestroCore/AudioInteractivePlayer.gd"),preload("Icons/AudioPlayerInteractive.svg"))

	add_custom_type("AudioSyncPlayer","AudioStreamPlayer",
	preload("Music/MaestroCore/AudioSyncPlayer.gd"),preload("Icons/AudioPlayerInteractive.svg"))
	
	add_custom_type("AudioListPlayer","AudioStreamPlayer",
	preload("Music/MaestroCore/AudioListPlayer.gd"),preload("Icons/AudioPlayerList.svg"))
